...
var METADATA_KEY = 'custom:metadataTest';
function setMetadata(value) {
  return function (target) {
    Reflect.defineMetadata(METADATA_KEY, value, target);
  };
}
var MyClass = (_dec = setMetadata('这是我的元数据信息'), _dec(_class = /*#__PURE__*/function () {
  function MyClass(adapter, demo1) {
...
var metadata = Reflect.getMetadata(METADATA_KEY, MyClass);
